...
<html>
	...
	<body>
		<?php
			...
			echo ''.$row['P_Price'].'<br>';
			echo'<button class="btn btn1" onclick="window.location.href=\'Update_Item_M.php?id='.$row['P_ID'].'\'">Update</button>';
			echo'<button class="btn btn1" onclick="window.location.href=\'delete_item_M.php?id='.$row['P_ID'].'\'">Delete</button>';
			echo '</div>';
				}
			}
			?>
