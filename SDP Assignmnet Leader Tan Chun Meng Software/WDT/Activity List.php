...
<html>
	...
	<body>
		<?php
			...
			echo'<button class="btn btn1" onclick="window.location.href=\'Update_Activity.php?id='.$row['AC_ID'].'\'">Update</button>';
			echo'<button class="btn btn1" onclick="window.location.href=\'delete_activity.php?id='.$row['AC_ID'].'\'">Delete</button>';
			echo '</div>';
				}
			}
			?>
