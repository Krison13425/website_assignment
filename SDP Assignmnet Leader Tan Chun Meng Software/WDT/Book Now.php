	 ...
	 <div class="item"><a href="staff_page.php"><i class="fas fa-home"></i>Home</a></div>
	   ...
	   <div class="item"><a href="View Customer Payment Status List.php"><i class="fas fa-tasks"></i>Payment Status List</a></div>
		...
		<div class="box">
			  ...
			  <center>
				<div class="inputBox">
					<a href='Further Book.php'><input type="button" value="FURTHER BOOKING" name="submit"></a>
				</div>
				
				<div class="inputBox">
					<a href="Current Book.php"><input type="button" value="CURRENT BOOKING" name="submit"></a>
				</div>
			  </center>
		</div>
