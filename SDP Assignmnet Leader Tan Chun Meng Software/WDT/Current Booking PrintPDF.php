...
<HTML>
	...
	<body>
		 ...
		 <center><h2 readonly style="font-family: 'Permanent Marker', cursive; font-size: 50px; color:gold;">Invoice</h2></center><br>
			...
			<br>
			<center><?php echo '<button class="btn btn2" onclick="window.location.href=\'Current Booking pdf.php?id='.$row['I_id'].'\'">Get Invoice</button>';?>
					<?php echo '<button class="btn btn2" onclick="window.location.href=\'Book Now.php\'">Home</button>';?>
		</div> 
