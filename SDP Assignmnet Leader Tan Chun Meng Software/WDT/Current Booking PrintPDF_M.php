...
<HTML>
	...
	<body>
		 ...
		 <center><h2 readonly style="font-family: 'Permanent Marker', cursive; font-size: 50px; color:gold;">Invoice</h2></center><br>
			...
			<br>
			<center><?php echo '<button class="btn btn2" onclick="window.location.href=\'Current Booking pdf_M.php?id='.$row['I_id'].'\'">Get Invoice</button>';?>
					<?php echo '<button class="btn btn2" onclick="window.location.href=\'Current Book_M.php\'">Home</button>';?>
		</div> 
