...
<html>
	...
	<div class="side-bar">
	 ...
	 <div class="item"><a href="Manager_page.php"><i class="fas fa-home"></i>Home</a></div>
	   ...
	   <div class="item"><a href="View Customer Payment Status List_M.php"><i class="fas fa-tasks"></i>Payment Status</a></div>
		...
		<?php
			...
			if($queryResults > 0){
				while ($row = mysqli_fetch_assoc($result))
				{
					...
					echo'<td><button class="btn btn2" onclick="window.location.href=\'Booking Done Update_M.php?id='.$row['C_BookingID'].'\'">DONE</button></td>';
					echo'<td><button class="btn btn2" onclick="window.location.href=\'Booking Cancel Update_M.php?id='.$row['C_BookingID'].'\'">CANCEL</button></td></tr>	';
			}
			echo "</tbody>";
			echo"</table>";
			}else{
