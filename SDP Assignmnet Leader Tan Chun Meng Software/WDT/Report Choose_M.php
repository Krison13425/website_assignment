	...
	<div class="side-bar">
	 ...
	 <div class="item"><a href="Manager_page.php"><i class="fas fa-home"></i>Home</a></div>
	   ...
	   <div class="item">
		...
		<div id=header></div>
		<div class="box">
			<h2 style="font-family: 'Permanent Marker', cursive; font-size: 30px; color:gold;">Report</h2>
			<form>
			  <center>
				<h2 style="font-family: 'Permanent Marker', cursive; font-size: 30px; color:black;">Monthly Sales Report</h2>
				
				<div class="inputBox">
					<a href="Monthly Sales Report.php" target="_blank"><input type="button" value="Print" name="submit"></a>
				</div>
				 
				<h2 style="font-family: 'Permanent Marker', cursive; font-size: 30px; color:black;">Tracking Report</h2>
				<div class="inputBox">
					<a href="Tracking Report.php" target="_blank"><input type="button" value="Print" name="submit"></a>
				</div>
			  </center>
			</form>	
		</div>
